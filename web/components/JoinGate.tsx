        ...
        <div className="mt-6 rounded-tile border border-edge bg-sunk p-5">
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="mt-3 text-[15px] leading-relaxed text-haze">
                We use Google rather than a password so nobody can register an address
                they do not own, and so you have no password to invent or lose. We never
                see your password.
              </p>
            </div>
          </div>
