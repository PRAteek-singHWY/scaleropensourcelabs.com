...
/** The six pages, in reading order. The nav and the footer both derive from this
...
export const PAGES = [
  ...
  // /team is the only page that names the mentors, so it stays in the nav rather
  // than being folded into Hall of Fame: the org chart appears on both, but the
  // mentor list and the shadow roles appear only here.
