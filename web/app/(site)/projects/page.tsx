  ...
  return (
    <main id="main">
                ...
                {p.stack.length > 0 && (
                  <ul className="mt-5 flex flex-wrap gap-2">
                    {p.stack.map((s) => (
                      <li
                        key={s}
                        className="rounded-md border border-seam bg-sunk px-2.5 py-1 font-mono text-[1rem] text-haze"
                      >
                        {s}
                      </li>
                    ))}
      ...
      >
              ...
              {upstream.map((p) => (
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <span className="rounded-md border border-seam bg-sunk px-2.5 py-1 font-mono text-[1rem] uppercase tracking-[0.14em] text-haze">
                      {p.org}
                    </span>
                    {p.tag ? (
        ...
        <p className="mt-10 font-mono text-[1rem] leading-relaxed text-dust">
